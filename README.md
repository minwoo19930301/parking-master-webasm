...
**▶️ 바로 실행: <https://parking-master-webasm.vercel.app>**

> 첫 화면에서 **바로 운전 시작**을 누르면 채점·절차 없이 즉시 주행할 수 있고,
> **기능시험 모드**를 누르면 도봉 장내기능시험 전체 순서로 채점 연습을 합니다.
> 휴대폰에서는 화면 하단 핸들을 원형으로 드래그하거나, 핸들 위 `터치/기울기`
> 버튼으로 기울기 조향으로 바꿀 수 있습니다.
